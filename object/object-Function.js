let myComputer = {                            // 1st Object              
    manufacture: 'Apple',
    model: 'Pro',
    processor: 'M3',
    year: 2024
}
let yourComputer = {                           // 2nd Objects
    manufacture: 'Dell',
    model: 'XPS',
    processor: 'i9',
    year: 2024
...
let computerInfo = function(computer){
    console.log(`${computer.manufacture} has produced new ${computer.model} model with ${computer.processor} processor in ${computer.year}.`);
}
